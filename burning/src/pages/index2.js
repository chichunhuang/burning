...
import background from "@site/static/img/pink_bg_Plain_SVG.svg";
...
function HomepageHeader() {
    ...
    (async function () {
     ...
     `;
      ...
      const [middle_pic, fade_noise] = await Promise.all([
        loadImage(logo),
        loadImage(noise),
      ]);
      ...
      aka
        ...
        .loadTexture(middle_pic)
        .setUniform("uTexture1", "uniform1i", 0)
        .loadTexture(fade_noise)
      ...
      function draw() {
        ...
        gl.uniform1f(uniform2, reverse ? (value -= 0.001) : (value += 0.005));
    ...
    <header className={clsx(styles.heroBanner)} style={{backgroundImage: `url('../../burning/img/pink_bg_Plain_SVG.svg')`}}  >
      ...
      <div className="container" >
        ...
        <div className={styles.buttons}>
          <Link className="button button--secondary button--lg" to="/docs/Gallery/GalleryAll">
            My Portfolio →
          </Link>
        </div>
      </div>
